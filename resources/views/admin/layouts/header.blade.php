                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade show active" id="kt_topbar_notifications_3" role="tabpanel">
                                        <!--begin::Items-->
                                        <div class="scroll-y mh-325px my-5 px-8">
                                        @foreach(\App\Models\inbox::where('recipient_id',\Illuminate\Support\Facades\Auth::id())->OrderBy('id','desc')->where('view',0)->get() as $inbox)
                                            <!--begin::Item-->
                                                <div class="d-flex flex-stack py-4">
                                                    <!--begin::Section-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Code-->
                                                        <span
                                                            class="w-70px badge badge-light-success me-4">{{substr($inbox->sender_name,0,9)}}</span>
                                                        <!--end::Code-->
                                                        <!--begin::Title-->
                            ...
                            <span class="menu-link py-3">
                                ...
                                <div
                                    ...
                                    <span
                                        ...
                                        <span
                                            class="menu-title  @if(Request::segment(1) == "projects-incomes" ) text-active-primary active @endif ">

                                                تقرير المدفوعات من العملاء
                                              </span>
                                    </span>
                                        </a>
                                    </div>
                                    ...
                                    <div data-kt-menu-placement="right-start"
                                         class="menu-item menu-lg-down-accordion">
                                        <a href="{{url('EmployeeProjects')}}">
                                    <span
                                        class="menu-link @if(Request::segment(1) == 'EmployeProjects'  ) active @endif py-3">
                                        <span class="menu-icon ">
                                            <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                                            <span class="svg-icon svg-icon-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <span
                                            class="menu-title  @if(Request::segment(1) == "EmployeProjects" ) text-active-primary active @endif ">
