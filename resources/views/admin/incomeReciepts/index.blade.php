...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <li class="breadcrumb-item text-gray-500">سندات القبض</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="" class="form" method="post" action="{{url('store-income_reciepts')}}">
                    @csrf
                    <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y me-n7 pe-7"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select name="project_id" id="project_id"  class="form-select form-select-lg form-select-solid" data-control="select2"
                                        data-dropdown-parent="#kt_modal_add_user_header" data-placeholder="اختـر..." data-allow-clear="false">
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('income_reciepts.datatable.data') }}',
                    data: {}
                },
                columns: [
            ...
            $.ajax({
                url: "{{ URL::to('/add-income_reciepts-button')}}",
