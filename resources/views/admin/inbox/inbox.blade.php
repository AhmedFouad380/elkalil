            ...
            <div class="d-flex flex-column flex-lg-row">
                ...
                <div class="flex-column flex-lg-row-auto w-100 w-lg-275px mb-10 mb-lg-0">
                    ...
                    <div class="card card-flush mb-0" data-kt-sticky="false" data-kt-sticky-name="inbox-aside-sticky"
                        ...
                        <div class="card-body">
                            <!--begin::Button-->
                            {{--                            <a href="#" class="btn btn-primary text-uppercase w-100 mb-10" data-toggle="modal" data-target="#kt_inbox_compose">رسالة جديدة</a>--}}

{{--                            <button type="button"--}}
{{--                                    class="btn btn-block btn-primary w-100 mb-10 text-uppercase py-4 px-6 text-center"--}}
                                ...
                                <div class="menu-item mb-3">
                                    ...
                                    <span class="menu-title fw-bolder">البريد الوارد</span>
                                      <span class="badge badge-light-success">
                                          {{\App\Models\inbox::where(function ($query) {
                                                    $query->where('recipient_id', auth()->id()) ;
                                                })->where(function ($query) {
                                                    $query->where('empl', 0)->orWhere('empl', 2);
                                                })->where('sub', 0)->where('view',0)->count()}}
                                      </span>
                                </span>
                                    <!--end::Inbox-->
                                </div>
                        ...
                        <div class="card-body p-0">
                                    ...
                                    <tr>
                                               ...
                                               class="d-flex align-items-center text-dark">
                                                ...
                                                <div class="symbol symbol-35px me-3">
                                                    <div class="symbol-label bg-light-danger">
                                                        <span
                                                            class="text-danger">@if($inbox->recipient_id == auth()->id()){{substr($inbox->sender_name, 0, 1)}}@else{{substr($inbox->recipient_name, 0, 1)}}@endif</span>
                                                    </div>
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Name-->
                                                <span
                                                    class="fw-bold">@if($inbox->recipient_id == auth()->id()){{$inbox->sender_name}}@else{{$inbox->recipient_name}}@endif</span>
                                                <!--end::Name-->
                                            </a>
                                        </td>
                                        <!--end::Author-->
                                        ...
                                        <td>
                                            <div class="text-dark mb-1">
                                                <a href="{{url('reply/'.$inbox->id)}}" class="text-dark">
                                                    <span class="fw-bolder">{{$inbox->title}}</span>
                                                    <br>
                                                    <span class="text-muted"><div
                                                            class="truncate ">{{$inbox->comments}}</div></span>
                                                </a>
                                            </div>
                                        </td>
                                        <!--end::Title-->
                                        ...
                                        <td class="w-200px text-end fs-7 pe-9">
                                            <span class="fw-bold">{{$inbox->date}} {{$inbox->time}}</span>
                                        </td>
                                        <!--end::Date-->
                                    </tr>
                                @endforeach
                            ...
                            <div class="row justify-content-center mt-5">
                                <nav aria-label="Page navigation example">
                                    ...
                                    @php
                                        $paginator =$inboxes->appends(request()->input())->links()->paginator;
