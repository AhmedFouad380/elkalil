...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <!--begin::Item-->
        <li class="breadcrumb-item text-gray-500">ملفات المشروع</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <div class="d-flex overflow-auto h-55px">
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                            ...
                            <!--begin::Nav item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6 active" href="{{url('projectFiles',$data->id)}}">ملفات المشروع</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item">
